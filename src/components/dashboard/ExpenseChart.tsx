  ...
  return (
    <div className="bg-surface rounded-2xl border border-subtle shadow-card p-6">
      <div className="flex items-start justify-between mb-6">
        <div>
          <h3 className="text-[15px] font-semibold text-text-primary">Expense Trends</h3>
          <p className="text-[12px] text-text-muted mt-0.5">Last 6 months</p>
        </div>
        <div className="flex gap-4">
          <div className="text-right">
            <div className="text-[11px] text-text-muted">Fuel</div>
            <div className="text-[14px] font-semibold text-blue-400">{formatCurrency(total.fuel)}</div>
          </div>
          <div className="text-right">
            <div className="text-[11px] text-text-muted">Maintenance</div>
