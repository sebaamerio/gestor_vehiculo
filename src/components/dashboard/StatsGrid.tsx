  ...
  const cards: StatCard[] = [
    {
      ...
      subValue: `${stats.activeVehicles} active`,
      icon: Car,
      iconBg: 'bg-accent/10',
    ...
    },
    {
      ...
      subValue: `${Math.round((stats.activeVehicles / stats.totalVehicles) * 100)}% of fleet`,
      icon: CheckCircle2,
    ...
    },
    {
      ...
      subValue: `${stats.inMaintenance} service · ${stats.outOfService} offline`,
      icon: Wrench,
